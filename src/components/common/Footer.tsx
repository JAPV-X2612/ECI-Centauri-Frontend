...
export const Footer: React.FC = () => (
  <footer className="relative z-10 mt-12 border-t border-purple-500/30 bg-slate-900/50 backdrop-blur-lg">
    <div className="max-w-7xl mx-auto px-6 py-6">
      <div className="flex items-center justify-between">
        <div className="text-sm text-gray-400">
          By <span className="text-purple-400 font-semibold">ECI Centauri Team</span>
        </div>
