...
export const ModelSettings: React.FC = () => (
  <div className="bg-slate-800/50 backdrop-blur-lg rounded-xl p-4 border border-purple-500/20">
    <h3 className="text-sm font-semibold mb-3 text-purple-300">AI Model</h3>
    <div className="space-y-3">
      <div>
        <label className="text-xs text-gray-400 mb-1 block">Model Type</label>
        <select className="w-full bg-slate-700/50 border border-purple-500/20 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500">
          <option>Neural Network (CNN)</option>
      ...
      <div>
        ...
        <input 
          ...
          step="0.001" 
          defaultValue="0.001" 
          className="w-full bg-slate-700/50 border border-purple-500/20 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-purple-500" 
        />
      </div>
      <div>
