...
export const AIPrediction: React.FC<AIPredictionProps> = ({ confidence }) => (
  <div className="bg-gradient-to-br from-nasa-900/30 to-blue-900/30 backdrop-blur-lg rounded-xl p-6 border border-nasa-500/30">
    ...
    <div className="grid grid-cols-3 gap-3">
      <div className="bg-slate-800/50 rounded-lg p-3 border border-nasa-500/20">
        <div className="text-xs text-gray-400 mb-1">Transit Depth</div>
        <div className="text-lg font-bold text-nasa-400">0.8%</div>
      ...
      <div className="bg-slate-800/50 rounded-lg p-3 border border-nasa-500/20">
        ...
        <div className="text-lg font-bold text-nasa-400">15.2</div>
