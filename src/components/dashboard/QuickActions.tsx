...
export const QuickActions: React.FC<QuickActionsProps> = ({ onAnalyzeDemo }) => (
  <div className="bg-slate-800/50 backdrop-blur-lg rounded-xl p-4 border border-purple-500/20">
    <h3 className="text-sm font-semibold mb-3 text-purple-300">Quick Start</h3>
    <button 
      onClick={onAnalyzeDemo} 
      className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 rounded-lg py-3 px-4 flex items-center justify-center gap-2 transition-all mb-2"
    >
